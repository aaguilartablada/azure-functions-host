...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class FunctionDescriptorProviderTests : IDisposable
    {
        ...
        public FunctionDescriptorProviderTests()
        {
            ...
            var providerArray = _host.Services.GetService<IEnumerable<IScriptBindingProvider>>().ToArray();
            _provider = new TestDescriptorProvider(_scriptHost, _host.Services.GetService<IOptions<ScriptJobHostOptions>>().Value, providerArray);
        }
